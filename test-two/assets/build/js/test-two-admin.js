...
(function ($) {
  ...
  $(function () {
    if (document.querySelector("#test-two-admin-component")) {
      var domContainer = document.querySelector("#test-two-admin-component");
...
/***/ })
/******/ ]);
//# sourceMappingURL=test-two-admin.js.map