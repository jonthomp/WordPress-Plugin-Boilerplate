...
var Shortcode = function Shortcode(_ref) {
  var id = _ref.id,
      data = _ref.data;
...
var _Shortcode = __webpack_require__(24);
...
(function ($) {
  ...
  $(function () {
    $(".wp-plugin-name-shortcode").each(function () {
      var id = $(this).attr("data-id");
      var data = JSON.parse($(this).attr("data-data"));
      var domContainer = document.querySelector("#wp-plugin-name-shortcode-" + id);
      _reactDom2.default.render(_react2.default.createElement(_Shortcode2.default, { id: id, data: data }), domContainer);
    });
  });
})(jQuery);
...
/***/ })
/******/ ]);
//# sourceMappingURL=wp-plugin-name-frontend.js.map