...
(function ($) {
  ...
  $(function () {
    if (document.querySelector("#wp-plugin-name-admin-component")) {
      var domContainer = document.querySelector("#wp-plugin-name-admin-component");
      _reactDom2.default.render(_react2.default.createElement("div", {}, "hello world"), domContainer);
    }
  });
})(jQuery);
...
/***/ })
/******/ ]);
//# sourceMappingURL=wp-plugin-name-admin.js.map