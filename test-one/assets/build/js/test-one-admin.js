...
(function ($) {
  ...
  $(function () {
    if (document.querySelector("#test-one-admin-component")) {
      var domContainer = document.querySelector("#test-one-admin-component");
...
/***/ })
/******/ ]);
//# sourceMappingURL=test-one-admin.js.map